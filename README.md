# HR Analytics & Workforce Dashboard (Power BI)
...
* **Retrenchment & Retirement Pipeline:** Maps and filters employees eligible for retirement or redundancy packages based on tenure (18+ years of service).
* **Actionable HR Lists:** Integrated tables providing operational lists of specific employees for HR management review.

### Tech Stack

* **Data Preparation:** Power Query (ETL, Custom Columns, Conditional Formatting logic).
* **Calculations & Logic:** DAX (Custom measures for explicit headcount and tracking).
